...
//###### Config ######
$absPthToSlf = config::$path.'admin/tiny_mce/tinyupload/tinyupload.php';  //The Absolute path (from the clients POV) to this file.
$absPthToDst = config::$path.'images/';                                   //The Absolute path (from the clients POV) to the destination folder.
$absPthToDstSvr = config::$serverpath.'images/';                         //The Absolute path (from the servers POV) to the destination folder. You will need to set permissions for this dir 0777 worked ok for me.
...
<script language="javascript" type="text/javascript" src="tinyupload.js"></script>
